...
- Kuehler Editorial-Papiergrund (neutrales Luminanz-Korn) + leichte CRT-Scanline (im RGB/gbrp multipliziert - YUV-Multiply wuerde den neutralen Grund gruen verfaerben). Typo in die Frames gebacken, keine Laufschrift. -> scripts/build_c14.py

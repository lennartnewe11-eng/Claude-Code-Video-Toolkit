...
- **Teil 1 (0-12s):** die universelle Formel als Cutaway-Collage. Das Erdreich ist ein echter BODEN-QUERSCHNITT (Nutzer, soil.jpg) als Textur - die Grube ist in die Schichten geschnitten (tiefer = aeltere Straten). Darin ein echter 3-DIMENSIONALER SEE: das WASSER-VIDEO (Nutzer, lakewater.mp4, ruhiger See mit Ruderboot) fuellt die Mulde als Seeoberflaeche (steigt/faellt mit dem Fuellstand), und die freigestellte VEGETATION (Nutzer, veg.png; Himmel + offenes Wasser gekeyt -> Ufer/Baeume/Huegel) bildet die UFERLINIE, die als ferner Uferwald ueber dem Wasser aufsteigt. Gras-Fransen auf der Oberflaeche. Editorial-Gleichung 1 EIN BECKEN + 2 GENUG WASSER = EIN SEE (gelb), sonst -> '„TROCKENE SENKE"' (rot) mit Rissen. -> scripts/gen_c15.py

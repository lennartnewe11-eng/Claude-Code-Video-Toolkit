...
- **Teil 1 (0-12s):** die universelle Formel als Cutaway-Collage. Das Erdreich ist ein echter BODEN-QUERSCHNITT (Nutzer, soil.jpg) als Textur - die Grube ist in die Schichten geschnitten (tiefer = aeltere Straten). Darueber sitzt perspektivisch ein 3-DIMENSIONALER SEE: das Seenfoto (Nutzer, veg.png; nur der weisse Himmel oben gekeyt, Wasser + Ufer erhalten) mit weich gefederten Kanten, laeuft unten ins tiefe Blau des Beckens. Gras-Fransen auf der Oberflaeche. Editorial-Gleichung 1 EIN BECKEN + 2 GENUG WASSER = EIN SEE (gelb), sonst -> '„TROCKENE SENKE"' (rot) mit Rissen. -> scripts/gen_c15.py

...
def beat_question():
    a=(BUILD/"c7_b2.ass")
    styles=[f"Style: Q,Liberation Sans,300,&H00000000,&H00000000,&H00000000,&H00000000,-1,0,0,0,100,100,0,0,1,0,0,7,0,0,0,1"]
    ev=["[Events]","Format: Layer, Start, End, Style, Name, MarginL, MarginR, MarginV, Effect, Text",
        f"Dialogue: 0,{at(0.3)},{at(D_B2)},Q,,0,0,0,,{{\\an7\\pos(1300,60)\\fad(220,0)}}?"]
    a.write_text(ass_header(styles)+"\n".join(ev)+"\n")

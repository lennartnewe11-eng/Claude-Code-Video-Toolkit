# Credits & Lizenzen — Hook

Alle Medien stammen aus freien Quellen. Bei CC-BY/BY-SA ist Namensnennung
erforderlich (im Abspann oder in der Videobeschreibung). Public Domain / CC0
benötigen keine Nennung, sind hier aber der Vollständigkeit halber gelistet.

## Footage (Wikimedia Commons)

| Segment | Datei | Quelle / Urheber | Lizenz |
|---|---|---|---|
| Japan (Shinkansen) | `japan.mp4` | „Shinkansen N700 Series Bullet Train Tokyo Station" — Don Ramey Logan | CC BY 4.0 |
| Frankreich (TGV) | `tgv.mp4` | „France TGV high speed trains" | CC BY 3.0 |
| China (CRH) | `china.mp4` | „CRH entering Yuyao Station 201907141725" | CC BY-SA 4.0 |
| USA-Bruch | `usa-break.jpg` | „Grand Junction Amtrak station platforms and sign" — Quincylvania | CC0 |
| Reichstes Land | `richest.jpg` | „Lower Manhattan, New York skyline from Liberty Island 2021" — Percival Kestreltail | CC BY-SA 3.0 |
| Wirtschaftsmacht | `economy.jpg` | „Lower Manhattan from Jersey City November 2014 panorama 2" — King of Hearts | CC BY-SA 3.0 |
...
| Politik: US-Flagge | `photos/usflag.jpg` | US-Flagge im Wind, Kent WA 2025 — Roc0ast3r (Wikimedia Commons) | CC0 |
| Korridor: Regionalkarte | `maps/neccorridor.jpg` | „Johnson's Virginia, Maryland, Delaware and Pennsylvania", 1862 — A. J. Johnson (Wikimedia Commons) | Public domain |
...
|---|---|---|---|
| Musik-Bett | `musicBed.mp3` | „Crypto" — Kevin MacLeod (incompetech.com) | CC BY 4.0 |
| Whoosh (Cuts) | `whoosh.mp3` | „Sound Design Elements Whoosh SFX 052" (Freesound) | CC0 |
| Impact / Boom | `impact.mp3` | „Sound Design Elements Impact SFX PS 001" (Freesound) | CC0 |
| Riser | `riser.mp3` | „rise5" (Freesound) | CC0 |
| Voiceover | `vo.m4a` | eigene Aufnahme (`0615_2.mov`) | — |

## Nötige Namensnennung (Vorschlag für Videobeschreibung)

> Musik: „Crypto" von Kevin MacLeod (incompetech.com), lizenziert unter CC BY 4.0.
> Footage: Shinkansen © Don Ramey Logan (CC BY 4.0); TGV (CC BY 3.0); CRH Yuyao
> (CC BY-SA 4.0); NY-Skyline © Percival Kestreltail / King of Hearts (CC BY-SA 3.0);
> verlassene Gleise © Peter Moore (CC BY-SA 2.0) — alle via Wikimedia Commons.
